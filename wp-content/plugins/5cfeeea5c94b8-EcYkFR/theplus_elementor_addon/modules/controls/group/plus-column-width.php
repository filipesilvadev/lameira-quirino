...
class Theplus_Column_Responsive extends Elementor\Widget_Base {
		...
		if($element->get_name() == 'column') {
			...
			if((isset($plus_extras) && empty($plus_extras)) || (!empty($plus_extras) && in_array('column_sticky',$plus_extras))){
				...
				$element->add_control(
					...
					[
						'label' => __( 'Sticky Desktop', 'theplus' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
				...
				$element->add_control(
					...
					[
						'label' => __( 'Sticky Tablet', 'theplus' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => __( 'Enable', 'theplus' ),
						'label_off' => __( 'Disable', 'theplus' ),					
						'default' => 'yes',
				...
				$element->add_control(
					...
					[
						'label' => __( 'Sticky Mobile', 'theplus' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => __( 'Enable', 'theplus' ),
						'label_off' => __( 'Disable', 'theplus' ),					
						'default' => 'no',
			...
			if((isset($plus_extras) && empty($plus_extras)) || (!empty($plus_extras) && in_array('custom_width_column',$plus_extras))){
				$element->add_control(
					...
					[
						'label' => __( 'Responsive Options for Breakpoints', 'theplus' ),
				...
				$repeater->add_control(
					...
					[
						'label' => __( '@Media Max-Width Value', 'theplus' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'default' => 'no',
						'label_on' => 'Yes',
						'label_off' => 'No',
				...
				$repeater->add_control(
					'media_max_width',
					[
						'label' => __( 'Select Max-Width Value(px)', 'theplus' ),
				...
				$repeater->add_control(
					...
					[
						'label' => __( '@Media Min-Width Value', 'theplus' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'default' => 'no',
						'label_on' => 'Yes',
						'label_off' => 'No',
				...
				$repeater->add_control(
					'media_min_width',
					[
						'label' => __( 'Select Min-Width Value(px)', 'theplus' ),
						'type' => Controls_Manager::SLIDER,
						'size_units' => [ 'px' ],
						'range' => [
							'px' => [
				...
				$repeater->add_control(
					'plus_column_hide',
					[
						'label' => __( 'Column Visibility', 'theplus' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'default' => '',
						'label_on' => 'Hide',
						'label_off' => 'Show',
		...
		if($element->get_name() == 'section') {
			...
			if((isset($plus_extras) && empty($plus_extras)) || (!empty($plus_extras) && in_array('section_scroll_animation',$plus_extras))){
				$element->add_control(
					...
					[
						'label' => __( 'In/Entrance Animation', 'theplus' ),
						'type' => Controls_Manager::SELECT,
						'default' => 'none',
						'options' => [
							'none'  => __( 'None', 'theplus' ),						
							'scale-smaller' => __( 'Scale smaller', 'theplus' ),
							'fade' => __( 'Fade in', 'theplus' ),
							'rotate-back' => __( '3D Rotate backward', 'theplus' ),
							'rotate-forward' => __( '3D Rotate forward', 'theplus' ),
							'carousel' => __( 'Carousel forward', 'theplus' ),
							'fly-up' => __( 'Fly up', 'theplus' ),
							'fly-left' => __( 'Fly left', 'theplus' ),
							'fly-right' => __( 'Fly right', 'theplus' ),
							'cube' => __( '3D cube (use 3D cube entrance animation on the next row to make this look good)', 'theplus' ),
						],
					]
				);
				$element->add_control(
					...
					[
						'label' => __( 'Exit Animation', 'theplus' ),
						'type' => Controls_Manager::SELECT,
						'default' => 'none',
						'options' => [						
							'none' => __( 'None', 'theplus' ),						
							'scale-smaller' => __( 'Scale smaller', 'theplus' ),
							'fade' => __( 'Fade out', 'theplus' ),
							'rotate-back' => __( '3D Rotate backward', 'theplus' ),
							'rotate-forward' => __( '3D Rotate forward', 'theplus' ),
							'carousel' => __( 'Carousel forward', 'theplus' ),
							'fly-up' => __( 'Fly up', 'theplus' ),
				...
				$element->add_control(
					...
					[
						'label' => __( 'Entrance Delay', 'theplus' ),
						'type' => Controls_Manager::NUMBER,
						'min' => -20,
						'max' => 20,
						'step' => 1,
						'default' => '',
						'description' => __( 'Add any value from -20 to 20. Tip: Positive numbers lengthen the entrance animation duration, and negative numbers shorten it.','theplus' ),
						'condition' => [
				...
				$element->add_control(
					...
					[
						'label' => __( 'Exit Delay', 'theplus' ),
						'type' => Controls_Manager::NUMBER,
						'min' => -20,
						'max' => 20,
						'step' => 1,
						'default' => '',
						'description' => __( 'The exit animation triggers when your container reaches more than 1/3th of the screen from the top (some effects are different, some are unchangeable). Add any value from -20 to 20.(Tip: Positive numbers lengthen the entrance animation duration, and negative numbers shorten it.)','theplus' ),
						'condition' => [
				...
				$element->add_control(
					...
					[
						'label' => __( 'Fix Body Overflow', 'theplus' ),
						'type' => Controls_Manager::SWITCHER,
						'label_on' => __( 'Yes', 'theplus' ),
						'label_off' => __( 'No', 'theplus' ),
						'return_value' => 'yes',
						'default' => 'no',
						'description' => __('Check this if you see an unwanted scrollbar that shows up for a very short time while scrolling with some effects & some themes.', 'theplus' ),
					]
				);
				$element->add_control(
					'plus_section_scroll_mobile_disable',
					[
						'label' => __( 'Mobile Disable/Off', 'theplus' ),
						'type' => Controls_Manager::SWITCHER,
						'label_on' => __( 'Yes', 'theplus' ),
						'label_off' => __( 'No', 'theplus' ),
						'return_value' => 'yes',
						'default' => 'no',
						'description' => __('Note : If you disable this option, It will be disabled for all sections of page.', 'theplus' ),
					]
				);
			}
			if(isset($plus_extras) && (empty($plus_extras) || (!empty($plus_extras) && in_array('section_custom_css',$plus_extras)))){
				$element->add_control(
					...
					[
						'label' => __( 'Section Overflow Hidden', 'theplus' ),
						'type' => Controls_Manager::SWITCHER,
						'label_on' => __( 'Yes', 'theplus' ),
						'label_off' => __( 'No', 'theplus' ),
						'return_value' => 'yes',
						'default' => 'no',
						'description' => __('If, Check Yes section scrollbar Overflow Hidden.', 'theplus' ),
						'separator' => 'before',
					]
				);
				$element->add_control(
	...
	public function plus_enqueue_scripts() {
		...
		wp_enqueue_script(
			'plus-resize-sensor',
			THEPLUS_ASSETS_URL .'js/extra/ResizeSensor.min.js',
			array( 'jquery' ),
			'1.7.0',
			true
		);
		...
		wp_enqueue_script(
			'plus-sticky-sidebar',
			THEPLUS_ASSETS_URL .'js/extra/sticky-sidebar.min.js',
			array( 'jquery', 'plus-resize-sensor' ),
			'3.3.1',
			true
		);
		...
		wp_enqueue_script(
			'jsticky',
			THEPLUS_ASSETS_URL .'js/extra/jquery.jsticky.js',
			array( 'jquery' ),
			'1.1.0',
			true
		);
	...
	protected function init() {
		...
		if((isset($plus_extras) && empty($plus_extras) && empty($theplus_options)) || (!empty($plus_extras) && in_array('column_sticky',$plus_extras))){
			add_action( 'elementor/frontend/before_enqueue_scripts', [ $this, 'plus_enqueue_scripts' ], 9 );
		}
	}

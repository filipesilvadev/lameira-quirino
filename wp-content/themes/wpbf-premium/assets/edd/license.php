...
function wpbf_premium_activate_license() {
	...
	if( isset( $_POST['wpbf_premium_license_activate'] ) ) {
		...
		$api_params = array(
			...
			'license' 	=> $license,
			'item_name' => urlencode( WPBF_PREMIUM_PLUGIN_NAME ), // the name of our product in EDD
			'url'       => home_url()
		);
			...
			if ( false === $license_data->success ) {
				...
				switch( $license_data->error ) {
					...
					case 'item_name_mismatch' :
						...
						$message = sprintf( __( 'This appears to be an invalid license key for %s.' ), WPBF_PREMIUM_PLUGIN_NAME );
						break;

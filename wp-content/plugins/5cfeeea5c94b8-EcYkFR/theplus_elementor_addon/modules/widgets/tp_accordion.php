...
class ThePlus_Accordion extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'active_accordion',
			[
				'label' => __( 'Active Accordion', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => '1',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Start', 'theplus' ),
						'icon' => 'eicon-h-align-left',
					],
					'right' => [
						'title' => __( 'End', 'theplus' ),
		...
		$this->add_control(
			'title_align',
			[
				'label' => __( 'Title Alignment', 'theplus' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'text-left' => [
		...
		$this->add_responsive_control(
            ...
            [
                'type' => Controls_Manager::SLIDER,
				'label' => __('Icon Space/Indent', 'theplus'),
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'accordion_space',
			[
				'label' => __( 'Accordion Between Space', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px'],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''  => __( 'None', 'theplus' ),
					'hover-style-1' => __( 'Style 1', 'theplus' ),
					'hover-style-2' => __( 'Style 2', 'theplus' ),
				],
			]
		);
		$this->add_control(
			...
			foreach ( $settings['tabs'] as $index => $item ) :
				...
				<div class="theplus-accordion-item">
					<<?php echo $settings['title_html_tag']; ?> <?php echo $this->get_render_attribute_string( $tab_title_setting_key ); ?>>
						...
						<?php echo '<span>'.$item['tab_title'].'</span>'; ?>

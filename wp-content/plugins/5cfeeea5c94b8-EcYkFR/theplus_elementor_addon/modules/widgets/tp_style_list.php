...
class ThePlus_Style_List extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Interactive Links', 'theplus' ),
		...
		$repeater->add_control(
			'hint_text',
			[
				'label' => __( 'Hint Text', 'theplus' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Featured', 'theplus' ),
				'placeholder' => __( 'Ex. Unique,Top,Featured...', 'theplus' ),
				'condition' => [
					'show_pin_hint' => 'yes',
				],
			]
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Background Style', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Enable', 'theplus' ),
				'label_off' => __( 'Disable', 'theplus' ),
				'separator' => 'before',
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'content_description' => __( 'List Item 1', 'theplus' ),
						'icon_fontawesome' => 'fa fa-check',
					],
					[
						'content_description' => __( 'List Item 2', 'theplus' ),
						'icon_fontawesome' => 'fa fa-times',
					],
					[
						'content_description' => __( 'List Item 3', 'theplus' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Read More Toggle', 'theplus' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => __( 'Space Between', 'theplus' ),
		...
		$this->start_controls_section(
            'section_styling',
            [
                'label' => __('Content Options', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Hint Text Style', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_responsive_control(
			'hint_align',
			[
				'label' => __( 'Hint Text Alignment', 'theplus' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'theplus' ),
		...
		$this->add_control(
			'hint_padding',
			[
				'label' => __( 'Hint Inner Padding', 'theplus' ),
		...
		$this->add_responsive_control(
            ...
            [
                'type' => Controls_Manager::SLIDER,
				'label' => __('Horizontal Adjust', 'theplus'),
				'default' => [
					'unit' => 'px',
					'size' => 5,
				],
		...
		$this->add_control(
            ...
            [
                'type' => Controls_Manager::SLIDER,
				'label' => __('Min Width Adjust', 'theplus'),
				'default' => [
					'unit' => 'px',
					'size' => 60,
				],
		...
		$this->add_responsive_control(
            ...
            [
                'type' => Controls_Manager::SLIDER,
				'label' => __('Vertical Adjust', 'theplus'),
				'default' => [
					'unit' => 'px',
					'size' => 0,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'On Hover Inverse Effect', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			...
			[
				'label' => __( 'NotSelected Item Opacity', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_group_control(
			...
			[
				'label' => __( 'NotSelected Item CSS Filter', 'theplus' ),
		...
		$this->add_control(
			'hover_effect_area',
			[
				'label' => __( 'Effect Area', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'individual',
				'options' => [
					'individual'  => __( 'Individual', 'theplus' ),
					'global' => __( 'Global', 'theplus' ),
				],
				'condition'    => [
					'hover_inverse_effect' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Global List Connection Id', 'theplus' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'description' => __( 'Note : Use unique id here and put same in all connected lists.', 'theplus' ),
				'condition'    => [
					'hover_inverse_effect' => 'yes',

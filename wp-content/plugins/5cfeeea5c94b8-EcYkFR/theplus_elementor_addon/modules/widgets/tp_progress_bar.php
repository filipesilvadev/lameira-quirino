...
class ThePlus_Progress_Bar extends Widget_Base {
    ...
    public function get_title() {
        return __('Progress Bar', 'theplus');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'main_style',
			[
				'label' => __( 'Select Main Style', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'progressbar',
				'options' => [
					'progressbar'  => __( 'Progress Bar', 'theplus' ),
					'pie_chart' => __( 'Pie Chart', 'theplus' ),
				],
			]
		);
		...
		$this->add_control(
			'pie_chart_style',
			[
				'label' => __( 'Pie Chart Style', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'style_1',
				'options' => [
		...
		$this->add_control(
			'progressbar_style',
			[
				'label' => __( 'Progress Bar Style', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'style_1',
				'options' => [
					'style_1' => __( 'Style 1', 'theplus' ),
		...
		$this->add_control(
			'pie_border_style',
			[
				'label' => __( 'Pie Chart Round Styles', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'style_1',
				'options' => [
					'style_1' => __( 'Style 1', 'theplus' ),
		...
		$this->add_control(
			'progress_bar_size',
			[
				'label' => __( 'Progress Bar Height', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'small',
				'options' => [
					'small' => __( 'Small Height', 'theplus' ),					
					'medium' => __( 'Medium Height', 'theplus' ),					
					'large' => __( 'Large Height', 'theplus' ),					
				],
				'condition'    => [
					'main_style' => [ 'progressbar' ],
		...
		$this->add_control(
			'value_width',
			[
				'label' => __( 'Dynamic Value (0-100)', 'theplus' ),
		...
		$this->add_control(
			'number',
			[
				'label' => __( 'Number', 'theplus' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '59', 'theplus' ),
				'placeholder' => __( 'Enter Number Ex. 50 , 60', 'theplus' ),
				'separator' => 'before',
			]
		);
		$this->add_control(
			'symbol',
			[
				'label' => __( 'Prefix/Postfix Symbol', 'theplus' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '%', 'theplus' ),
				'placeholder' => __( 'Enter Symbol', 'theplus' ),
			]
		);
		$this->add_control(
			'symbol_position',
		...
		$this->add_control(
			'icon_postition',
			[
				'label' => __( 'Icon Title Before after', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'before',
				'options' => [
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Pie Chart Setting', 'theplus'),
		...
		$this->add_control(
			'pie_value',
			[
				'label' => __( 'Dynamic Value (0-1)', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%' ],
				'range' => [					
					'%' => [
		...
		$this->add_control(
			'pie_size',
			[
				'label' => __( 'Pie Chart Circle Size', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px' ],
				'range' => [					
					'px' => [
		...
		$this->add_control(
			'data_empty_fill',
			[
				'label' => __( 'Pie Empty Color', 'theplus' ),
		...
		$this->add_control(
			'pie_empty_color',
			[
				'label' => __( 'pie Chart Empty Color', 'theplus' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'condition'    => [
		...
		$this->add_control(
			'pie_fill',
			[
				'label' => __( 'Chart Fill Color', 'theplus' ),
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Title Setting', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} span.progress_bar-title' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
			'title_margin',
			[
				'label' => __( 'Title Left Margin', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%' ],
				'range' => [					
					'%' => [
				...
				'selectors' => [
					'{{WRAPPER}} span.progress_bar-title' => 'margin-left: {{SIZE}}{{UNIT}};',
				],
				'condition'    => [					
					'main_style' => [ 'progressbar' ],
				],
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Sub Title Setting', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_group_control(
		...
		$this->add_control(
			'subtitle_color',
			[
				'label' => __( 'Sub Title Color', 'theplus' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Number Setting', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_group_control(
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Number Prefix/Postfix Style', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				'label' => __( 'Prefix/Postfix Color', 'theplus' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Icon/Image Setting', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		...
		$this->add_responsive_control(
			'image_border_radius',
			[
				'label'      => __( 'Image Border Radius', 'theplus' ),
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Progress Bar Setting', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition'    => [					
					'main_style' => [ 'progressbar' ],
				],
		...
		$this->add_control(
			'progress_bar_margin',
			[
				'label' => __( 'Progress Bar Top Margin', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['%' ],
				'range' => [					
					'%' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Seprator Color', 'theplus' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
	 ...
	 protected function render() {
		...
		$pie_size = $settings['pie_size']['size'];												

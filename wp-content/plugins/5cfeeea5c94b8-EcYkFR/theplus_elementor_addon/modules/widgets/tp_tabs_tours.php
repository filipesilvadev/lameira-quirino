    ...
    protected function _register_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'page_template' => __( 'Page Template', 'theplus' ),
				],
			]
		);
		$repeater->add_control(
		...
		$repeater->add_control(
			'backend_preview_template',[
				...
				'description' => __( 'Note : If disabled, Template will not visible/load in the backend for better page loading performance.', 'theplus' ),
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			'default_active_tab',
			[
				'label' => __( 'Default Active Tab', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => '1',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Connection Carousel ID', 'theplus' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',				
				'separator' => 'before',
			]
		...
		$this->add_control(
			'nav_full_width',
			[
				'label' => __( 'Nav Full-Width', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'nav_same_width',
			[
				'label' => __( 'Nav Equal Width', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'theplus' ),
				'label_off' => __( 'No', 'theplus' ),
				'default' => 'no',
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Navigation Area Background', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
			]
        );
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			'nav_tab_opacity',
			[
				'label' => __( 'Navigation Opacity', 'theplus' ),
				'type' => Controls_Manager::SLIDER,				
				'range' => [
					'' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'nav_tab_scale',
			[
				'label' => __( 'Navigation Scale/Zoom', 'theplus' ),
				'type' => Controls_Manager::SLIDER,				
				'range' => [
					'' => [
						'min' => -0.3,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Navigation Active Opacity', 'theplus' ),
				'type' => Controls_Manager::SLIDER,				
				'range' => [
					'' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Navigation Active Scale/Zoom', 'theplus' ),
				'type' => Controls_Manager::SLIDER,				
				'range' => [
					'' => [
						'min' => -0.3,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					''  => __( 'None', 'theplus' ),
					'nav_full' => __( 'Full Width (For Less tabs) ', 'theplus' ),
					'nav_one' => __( 'One By One', 'theplus' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Accordion Navigation Options', 'theplus' ),
    ...
    protected function render() {
		...
		if($animation_effects=='no-animation'){
			...
			$tab_nav ='<div class="theplus-tabs-nav-wrapper elementor-tabs-wrapper '.esc_attr($nav_align).' '.esc_attr($nav_vertical_align).'">';
				$tab_nav .='<ul class="plus-tabs-nav  '.esc_attr($nav_full_width).' '.esc_attr($full_icon).'">';
		...
		$output ='<div class="theplus-tabs-wrapper elementor-tabs '.esc_attr($animated_class).' '.esc_attr($responsive_class).'" id="'.esc_attr($uid).'" data-tabs-id="'.esc_attr($uid).'"  data-connection="'.esc_attr($connect_carousel).'" '.$default_active.' '.$animation_attr.' role="tablist">';

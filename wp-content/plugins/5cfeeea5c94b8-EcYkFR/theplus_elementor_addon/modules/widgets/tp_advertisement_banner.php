...
class ThePlus_Advertisement_Banner extends Widget_Base {
    ...
    public function get_title() {
        return __('Advertisement Banner', 'theplus');
    }
	...
	public function get_style_depends() {
		return [ 'theplus-advertisement-banner' ];
	}
	...
	$this->add_control(
		...
		[
			...
			'default' => __( 'This Is Title', 'theplus' ),
			'separator' => 'before',
		]
	);
	//end titile
	...
	$this->add_control(
		'subtitle',
		[
			'label' => __( 'SubTitle', 'theplus' ),
			'type' => Controls_Manager::TEXT,
			'default' => __( 'This Is Subtitle', 'theplus' ),
			'separator' => 'before',
		]
	);
	//start subtitile	
	...
	$this->add_control(
		'hov_styles',
		[
			'label' => __( 'Hover Styles', 'theplus' ),
			'type' => Controls_Manager::SELECT,
			'default' => 'addbanner-image-blur',
			'options' => [
				'addbanner-image-blur' => __( 'Blur Effect', 'theplus' ),
				'simple' => __( 'Simple', 'theplus' ),
				'addbanner-image-vertical' => __( 'Vertical', 'theplus' ),
				'hover-tilt' => __( 'Parallax', 'theplus' ),				
			],
			'condition'    => [
	...
	$this->start_controls_section(
			...
			[
				'label' => __( 'Subitle Style', 'theplus' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
	);
	$this->add_group_control(
	...
	$this->add_control(
		...
		[
			'label' => __( 'Subtitle Color', 'theplus' ),
			'type' => \Elementor\Controls_Manager::COLOR,
			'default' => '#313131',
			'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
	...
	$this->add_control(
		...
		[
			'label' => __( 'Subtitle Hover Color', 'theplus' ),
			'type' => \Elementor\Controls_Manager::COLOR,
			'default' => '#313131',
			'scheme' => [
				'type' => \Elementor\Scheme_Color::get_type(),
	...
	$this->start_controls_section(
			...
			[
				'label' => __( 'Animation Settings', 'theplus' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
	);
	$this->add_control(
		...
		[
			'label' => __( 'Content Hover Effects', 'theplus' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
	...
	$this->start_controls_section(
			'boxshadow_setting',
			[
				'label' => __( 'Background Setting', 'theplus' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
	);	
	$this->start_controls_tabs( 'tabs_box_shadow_style' );
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Background Overlay', 'theplus' ),

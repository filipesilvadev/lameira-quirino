		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'layout-style-1'  => __( 'Layout 1', 'theplus' ),
				],
				'condition' => [
					'style!' => 'carousel',
				],

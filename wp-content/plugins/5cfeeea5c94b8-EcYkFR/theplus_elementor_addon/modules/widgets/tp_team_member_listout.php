...
class ThePlus_Team_Member_ListOut extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Style 4 Shape Options', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition'   => [
					'style' => ['style-4'],
				],
		...
		$this->add_control(
			'extra_layered_image',
			[
				'label' => __( 'Extra Layer Image', 'theplus' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => '',
				],
				'description' => __( 'Use image preferred in PNG with any shape which will be used to give layered effect to your design.', 'theplus' ),
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Animation for Extra Layer Image', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Inner Background Color', 'theplus' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [

...
class Theplus_Tooltips_Option_Group extends Elementor\Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['plus_tooltip_interactive'] = array(
			'label' => __( 'Tooltips Interactive', 'theplus' ),
		...
		$fields['plus_tooltip_position'] = array(
			...
			'options' => [
				...
				'top' => __( 'Top', 'theplus' ),
				'top-start' => __( 'Top Start', 'theplus' ),
				'top-end' => __( 'Top End', 'theplus' ),
				'bottom' => __( 'Bottom', 'theplus' ),
			],
		);
		$fields['plus_tooltip_theme'] = array(
			'label' => __( 'Theme', 'theplus' ),
			'type' => Controls_Manager::SELECT,
			'default' => 'dark',
			'options' => [
				'dark'  => __( 'Dark', 'theplus' ),
				'light' => __( 'Light', 'theplus' ),
				'translucent' => __( 'Translucent', 'theplus' ),
			],
			'separator' => 'after',
		);

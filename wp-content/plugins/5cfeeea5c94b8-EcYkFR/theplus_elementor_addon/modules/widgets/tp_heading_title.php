...
class Theplus_Ele_Heading_Title extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
            'heading_style', [
                ...
                'options' => [
                    ...
                    'style_6' => __('Vertical Border', 'theplus'),
		...
		$this->add_control(
            'top_clr',
            [
                'label' => __('Separator Vertical Color', 'theplus'),
                'type' => Controls_Manager::COLOR,
                'default' => '#1e73be',
                'selectors' => [
		...
		$this->add_control(
            ...
            [
				'type' => Controls_Manager::SWITCHER,
				'label' => __('Center Alignment In Mobile', 'theplus'),
				'default' => 'no',				
			]
		);
		$this->end_controls_section();
					...
					if($heading_style =="style_1" ){
						...
						if(!empty($settings["title"])){
							...
							$title_con ='<div class="head-title '.esc_attr($mobile_center).'" > ';
								$title_con .='<'.esc_attr($settings["title_h"]).' class="heading-title '.esc_attr($mobile_center).' '.esc_attr($reveal_effects).' '.esc_attr($title_gradient_cass).'" '.$effect_attr.'  data-hover="'.esc_attr($settings["title"]).'">';

...
class ThePlus_Dynamic_Devices extends Widget_Base {
    ...
    public function get_title() {
        return __('Dynamic Device', 'theplus');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'carousal' => __( 'Special Carousel', 'theplus' ),
				],
			]
		);
		$this->add_control(
			'device_mockup',
			[
				'label' => __( 'Type', 'theplus' ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'mobile' => [
						'title' => __( 'Mobile', 'theplus' ),
						'icon' => 'fa fa-mobile',
					],
					'tablet' => [
						'title' => __( 'Tablet', 'theplus' ),
						'icon' => 'fa fa-tablet',
					],
					'laptop' => [
						'title' => __( 'Laptop', 'theplus' ),
						'icon' => 'fa fa-laptop',
					],
					'desktop' => [
						'title' => __( 'Desktop', 'theplus' ),
						'icon' => 'fa fa-desktop',
					],
				],
				'default' => 'laptop',
		...
		$this->add_control(
			'device_mobile',
			[
				'label' => __( 'Mobile Device', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'iphone-white-flat',
				'options' => [
					'iphone-white-flat'  => __( 'iPhone White (320px x 594px)', 'theplus' ),
					'iphone-x-black' => __( 'iPhone X Black (320px x 672px)', 'theplus' ),
					'iphone-browser' => __( 'iPhone Browser (320px x 470px)', 'theplus' ),
					'iphone-minimal' => __( 'iPhone Minimal (300px x 527px)', 'theplus' ),
					'iphone-minimal-white' => __( 'iPhone Minimal White (320px x 564px)', 'theplus' ),
					's9-black' => __( 'S9 Black (320px x 668px)', 'theplus' ),
					's9-jet-black' => __( 'S9 Jet Black (320px x 672px)', 'theplus' ),
					's9-white' => __( 'S9 White (320px x 668px)', 'theplus' ),
				],
				'condition'    => [
					'device_mode' => [ 'normal' ],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'iphone-white-flat-carousal'  => __( 'iPhone White (500px x 890px)', 'theplus' ),
				],
				'condition'    => [
					'device_mode' => [ 'carousal' ],
		...
		$this->add_control(
			'device_tablet',
			[
				'label' => __( 'Tablet Device', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'ipad-vertical-white',
				'options' => [
					'ipad-vertical-white'  => __( 'Ipad Vertical White (480px x 646px)', 'theplus' ),
					'ipad-horizontal-white'  => __( 'Ipad Horizontal White (470px x 348px)', 'theplus' ),
					'ipad-browser'  => __( 'Ipad Browser (550px x 625px)', 'theplus' ),
				],
				'condition'    => [
					'device_mode' => [ 'normal' ],
		...
		$this->add_control(
			'device_laptop',
			[
				'label' => __( 'Laptop Device', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'laptop-macbook-black',
				'options' => [
					'laptop-macbook-black'  => __( 'Macbook Black (800px x 500px)', 'theplus' ),
					'laptop-macbook-minimal'  => __( 'Macbook Minimal (700px x 414px)', 'theplus' ),
					'laptop-macbook-white-minimal'  => __( 'Macbook White Minimal(770px x 480px)', 'theplus' ),
					'laptop-macbook-white'  => __( 'Macbook White (800px x 525px)', 'theplus' ),
					'laptop-windows'  => __( 'Windows Laptop (800px x 471px)', 'theplus' ),
				],
				'condition'    => [
					'device_mode' => [ 'normal' ],
		...
		$this->add_control(
			'device_desktop',
			[
				'label' => __( 'Desktop Device', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'desktop-imac-minimal',
				'options' => [
					'desktop-imac-minimal'  => __( 'iMac Minimal (1000px x 565px)', 'theplus' ),
				],
				'condition'    => [
					'device_mode' => [ 'normal' ],
		...
		$this->add_control(
			'slider_gallery',
			[
				'label' => __( 'Select Multiple Images', 'theplus' ),
		...
		$this->add_control(
			'device_link_popup',
			[
				'label' => __( 'Select Link/Popup', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'drop_waves'  => __( 'Drop Waves', 'theplus' ),
				],
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Carousal Options', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'device_mode' => 'carousal',
				],
		...
		$this->add_control(
			'carousal_columns',
			[
				'label' => __( 'Carousal Column', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'multiple',
				'options' => [
					'single'  => __( 'Single Slide', 'theplus' ),
					'multiple' => __( 'Multiple', 'theplus' ),
				],
			]
		);
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Carousel Slide', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_responsive_control(
			'carousal_slide_gap',
			[
				'label' => __( 'Slide Gap/Space', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -10,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Adjust Slide Space', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => -100,
		...
		$this->add_responsive_control(
			'carousal_width',
			[
				'label' => __( 'Carousal Width', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'slide_opacity_normal',[
				'label' => __( 'Slide Opacity', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '',
					'size' => 1,
		...
		$this->add_control(
			'slide_opacity_hover',[
				'label' => __( 'Slide Hover Opacity', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => '',
					'size' => 1,
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Device Layout', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_responsive_control(
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Device Background', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_control(

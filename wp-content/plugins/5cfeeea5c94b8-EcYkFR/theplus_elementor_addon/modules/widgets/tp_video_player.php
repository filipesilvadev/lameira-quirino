    ...
    protected function _register_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'label' => __('YouTube Id', 'theplus'),
                'label_block' => true,
                'separator' => 'before',
                'default' => __('2ReiWfKUxIM', 'theplus'),
				'placeholder' => __( 'YouTube ID : 2ReiWfKUxIM', 'theplus' ),
				'condition'    => [
					'video_type' => 'youtube',
				],
            ]
		...
		$this->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => __('Vimeo Id', 'theplus'),
                'label_block' => true,
                'separator' => 'before',
                'default' => __('87591302', 'theplus'),
				'placeholder' => __( 'Vimeo ID : 87591302', 'theplus' ),
				'condition'    => [
					'video_type' => 'vimeo',
				],
            ]
		...
		$this->add_control(
			'mp4_link',
			[
				'label' => __( 'Mp4 Video Link', 'theplus' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Video Options', 'theplus' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'video_touch_disable',
			[
				'label' => __( 'Video Touch Disable', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'modest_branding',
			[
				'label' => __( 'Modest Branding', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [
					'video_type' => [ 'youtube' ],
					'video_controls' => 'yes',
		...
		$this->add_control(
			'rel',
			[
				'label' => __( 'Suggested Videos', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'theplus' ),
				'label_on' => __( 'Show', 'theplus' ),
				'condition' => [
		...
		$this->add_control(
			'yt_privacy',
			[
				'label' => __( 'Privacy Mode', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'theplus' ),
				'condition' => [
					'video_type' => 'youtube',
				],
			]
		...
		$this->add_control(
			'vimeo_portrait',
			[
				'label' => __( 'Intro Portrait', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'theplus' ),
				'label_on' => __( 'Show', 'theplus' ),
				'default' => 'yes',
		...
		$this->start_controls_section(
			'section_image_icon',
			[
				'label' => __( 'Image/Icon', 'theplus' ),
			]
		);
		$this->add_control(
			'image_banner',
			[
				'label' => __( 'Only Icon / Full Banner', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'banner_img',
				'options' => [
					'only_icon' => __( 'Only Icon image', 'theplus' ),
					'banner_img' => __( 'Banner Image', 'theplus' ),
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => __('Title of Video', 'theplus'),
                'label_block' => true,
                'separator' => 'before',
                'default' => __('Video Title', 'theplus'),
				'condition'    => [
					'display_banner_image' => 'yes',
					'image_banner' => 'banner_img',
				],
		...
		$this->add_control(
			'background_color',
			[
				'label'     => __( 'Title Background Color', 'theplus' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Video Styling', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
		$this->add_control(
			'popup_video',
			[
				'label' => __( 'Video On Popup', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Off', 'theplus' ),
				'label_on' => __( 'On', 'theplus' ),
				'default' => 'no',
		...
		$this->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => __('Transform Effect', 'theplus'),
                'label_block' => true,
                'separator' => 'before',
				'placeholder' => __( 'rotate(2deg) skew(50deg)', 'theplus' ),
                'default' => '',
            ]
        );
		$this->add_group_control(
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Hover Box Shadow', 'theplus' ),
		...
		$this->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label' => __('Hover Transform Effect', 'theplus'),
                'label_block' => true,
				'placeholder' => __( 'rotate(2deg) skew(50deg)', 'theplus' ),
                'default' => '',
            ]
        ...
        $settings = $this->get_settings_for_display();
			...
			$video_content=$banner_url=$video_space=$image_video_url=$image_video=$image_alt=$only_image=$title=$banner_image='';
				...
				if(!empty($settings["only_img"]["url"])){
						$only_img_icon = $settings["only_img"]["url"];
			 ...
			 if(!empty($settings["image_video"]["url"])){
						$image_video = $settings["image_video"]["url"];

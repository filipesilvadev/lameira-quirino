...
class ThePlus_Number_Counter extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'max_number',
			[
				'label' => __( 'Number Value', 'theplus' ),
				'type' => Controls_Manager::NUMBER,
				'default' => __( '1000', 'theplus' ),
				'description' => __('Enter the value of number/digits you want to showcase in icon counter. E.g, 100,999,etc..','theplus' ),				
			]
		);
		$this->add_control(
			'min_number',
			[
				'label' => __( 'Animation Starting Number Value', 'theplus' ),
				'type' => Controls_Manager::NUMBER,
				'default' => __( '0', 'theplus' ),
				'description' => __('Enter the digit from which you want to start the animation on scroll. E.g. 0,10,80, etc','theplus' ),				
		...
		$this->add_control(
            ...
            [
				...
				'label' => __('Number gap for animation', 'theplus'),
				'default' => [
					'unit' => '',
					'size' => 5,
				],
				...
				'description' => __('Enter the value of number you want while animation.','theplus' ),
            ]
        );
		$this->add_control(
            'delay_number',
            [
                'type' => Controls_Manager::SLIDER,
				'label' => __('Time delay in animation gap', 'theplus'),
				'default' => [
					'unit' => '',
					'size' => 5,
				],

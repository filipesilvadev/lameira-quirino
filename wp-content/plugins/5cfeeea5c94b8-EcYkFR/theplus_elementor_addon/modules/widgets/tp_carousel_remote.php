...
class ThePlus_Carousel_Remote extends Widget_Base {
    ...
    public function get_title() {
        return __('Carousel Remote', 'theplus');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'carousel_unique_id',
			[
				'label' => __( 'Unique Connection ID', 'theplus' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'separator' => 'after',
				'description' => __('Enter the value of ID of carousel/Switcher, which you want to remotely connect with this.','theplus'),
			]
		);
		$this->add_control(
			'remote_type',
			[
				'label' => __( 'Remote Type', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'carousel',
				'options' => [
					'carousel'  => __( 'Carousel', 'theplus' ),
					'switcher' => __( 'Switcher', 'theplus' ),					
				],
				'separator' => 'after',
			]
		);
		$this->add_control(
			'nav_next_slide',
			[
				'label' => __( 'Button 1 Text', 'theplus' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'nav_prev_slide',
			[
				'label' => __( 'Button 2 Text', 'theplus' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'nav_prev_icon',
			[
				'label' => __( 'Custom Icon 1', 'theplus' ),
		...
		$this->add_control(
			'nav_next_icon',
			[
				'label' => __( 'Custom Icon 2', 'theplus' ),
				'type' => Controls_Manager::MEDIA,
				'default' => [
					'url' => '',
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Button Gap/Space', 'theplus' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
	 ...
	 protected function render() {
		...
		$remote_type = $settings["remote_type"];
			...
			if($settings["nav_icon_style"]=='none'){
				...
				$nav_prev_icon=$settings['nav_prev_icon']['url'];
				$nav_next_icon=$settings['nav_next_icon']['url'];

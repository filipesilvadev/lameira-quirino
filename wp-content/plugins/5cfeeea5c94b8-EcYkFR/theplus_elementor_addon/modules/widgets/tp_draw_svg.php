...
class ThePlus_Draw_Svg extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			'select_svg_option',
			[
				'label' => __( 'Select SVG Option', 'theplus' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'svg_icons',
				'options' => [
					'svg_icons'  => __( 'Pre Built SVG Icon', 'theplus' ),
					'image' => __( 'Custom Upload', 'theplus' ),
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'on_hover_draw',
			[
				'label' => __( 'On Hover Draw', 'theplus' ),

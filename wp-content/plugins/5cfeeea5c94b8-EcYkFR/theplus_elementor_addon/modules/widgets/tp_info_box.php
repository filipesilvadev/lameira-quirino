...
class ThePlus_Info_Box extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style_4' => __( 'Style-4', 'theplus' ),
					'style_7' => __( 'Style-5', 'theplus' ),
					'style_11' => __( 'Style-6', 'theplus' ),
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
            'loop_content',
            [
				'label' => __( 'Carousel InfoBox', 'theplus' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'font_awesome'  => __( 'Font Awesome', 'theplus' ),
					'icon_mind' => __( 'Icons Mind', 'theplus' ),
					'icon_image' => __( 'Icon Image', 'theplus' ),
				],
				'condition' => [
					'info_box_layout' => 'single_layout',
					'image_icon' => 'icon',
		...
		$this->add_control(
			'display_pin_text',
			[
				'label' => __( 'Display Pin Text', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Enable', 'theplus' ),
				'label_off' => __( 'Disable', 'theplus' ),
				'default' => 'no',
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors'  => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .infobox-overlay-color' => 'background: {{VALUE}};',
				],
				'condition' => [
					'bg_hover_animation' => 'hover_normal',
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner .info-icon-content .service-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pt_plus_info_box .info-box-inner .info-icon-content .service-img',
			]
		);
		$this->end_controls_tab();
		$this->start_controls_tab(
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-icon-content .service-img' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-icon-content .service-img',
			]
		);
		$this->end_controls_tab();
		$this->end_controls_tabs();
		...
		$this->start_controls_section(
            ...
            [
                'label' => __('Pin Text Style', 'theplus'),
                'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'info_box_layout' => 'single_layout',
					'main_style' => 'style_3',
		...
		$this->add_control(
			'pin_text_border',
			[
				'label' => __( 'Pin Text Border', 'theplus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'theplus' ),
				'label_off' => __( 'Hide', 'theplus' ),
				'default' => 'no',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-pin-text' => 'color: {{VALUE}};',
				],
				'separator' => 'after',
			]
		);
		$this->add_group_control(
			...
			[
				...
				'types'     => [ 'classic', 'gradient' ],
				'selector'  => '{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-pin-text',
				'separator' => 'before',
			]
		);
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-pin-text' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'condition' => [
					'pin_text_border' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-pin-text' => 'border-color: {{VALUE}}',
				],
				'separator' => 'before',
				'condition' => [
					'pin_text_border' => 'yes',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .pt_plus_info_box .info-box-inner:hover .info-pin-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_group_control(
	 ...
	 protected function render() {
		...
		if($image_icon == 'icon'){
			if($settings["icon_font_style"]=='font_awesome'){
				...
				$icons_image = '<div class="service-icon-image service-icon '.esc_attr($service_icon_style).'"><img src="'.esc_url($settings["icons_image"]["url"]).'" class="icon-image-set" alt="'.esc_attr($image_alt).'"/></div>';
			}else{
				$icons = $icons_image='';
			}
			if(!empty($icons)){
			...
			if(!empty($settings["loop_content"])) {
				...
				foreach($settings["loop_content"] as $item) {
						...
						if(!empty($item['loop_title'])){
							...
							if (!empty($settings['loop_url_link']['url'])){
								$list_title = '<a '.$this->get_render_attribute_string( "loop_box_link" ).'><h6 class="service-title ">'.esc_html($loop_title).'</h6></a>';						
							}else{
		...
		if ($info_box_layout == 'single_layout'){	
			...
			if($main_style == 'style_3'){
				...
				if(!empty($settings["display_pin_text"]) && $settings["display_pin_text"]=='yes'){
					$pin_text='<div class="info-pin-text">'.$settings["pin_text_title"].'</div>';
				}
				$output .= '<div class="info-box-bg-box '.esc_attr($serice_box_border).'  '.esc_attr($inner_js_tilt).'" '.$this->get_render_attribute_string( 'tilt_parallax' ).'>';
					$output .= '<div class="'.esc_attr($service_align).'">';
						$output .= '<div class="service-center  ">';

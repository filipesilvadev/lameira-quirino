...
class ThePlus_Before_After extends Widget_Base {
    ...
    public function get_title() {
        return __('Before After', 'theplus');
    }
    ...
    protected function _register_controls() {
		...
		$this->add_control(
            'before_image', [
				...
				'label' => __('Image for Before', 'theplus'),
			]
        );
		$this->add_control(
            'before_label',
            [
                ...
                'label' => __('Label for Before', 'theplus'),
                'label_block' => true,
                'separator' => 'after',
                'default' => '',
            ]
		...
		$this->add_control(
            'after_image', [
				'type' => Controls_Manager::MEDIA,
				'label' => __('Image for After', 'theplus'),
			]
        );
		$this->add_control(
            'after_label',
            [
                'type' => Controls_Manager::TEXT,
                'label' => __('Label for After', 'theplus'),
                'label_block' => true,
                'separator' => 'after',
                'default' => '',
            ]
		...
		$this->add_control(
            'separator_style', [
                'type' => Controls_Manager::SELECT,
                'label' => __('Separator Style', 'theplus'),
                'default' => 'middle',
                'options' => [
                    'middle' => __('Middle', 'theplus'),
		...
		$this->add_control(
            'separate_bg_color',
            [
                'label' => __('Separator Bottom Bg Color', 'theplus'),
                'type' => Controls_Manager::COLOR,
		...
		$this->add_control(
            'image_separator', [
				'type' => Controls_Manager::MEDIA,
				'label' => __('Separator Icon', 'theplus'),
				'separator' => 'before',
			]
        );
		$this->add_control(
            'separate_position', [
				'type' => Controls_Manager::SLIDER,
				'label' => __('Separator Position', 'theplus'),
				'size_units' => '%',
				'default' => [
					'size' => 50,
				],
	 ...
	 protected function render() {
		...
		$uid=uniqid("bf_af");
			...
			/*--Plus Extra ---*/
				...
				$bf_af ='<div class="pt_plus_before_after '.esc_attr($uid).' '.$animated_class.'" '.$attr_data.'  '.$animation_attr.'>';
